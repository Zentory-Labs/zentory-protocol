...
If after that you cannot find what is novel, where in the ecosystem we sit, or how we differentiate, please open an issue or email `info@zentorylabs.com` — that's a documentation bug on our side.
